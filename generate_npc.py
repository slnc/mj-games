...
# - Profession is the name of the profession.
# - p_male is the probability of this profession being chosen for a male NPC.
#     The sum of all p_male must be exactly 1.
# - p_female is like p_male but for female NPCs.
#
# TODO: every time a new profession is added or removed the whole
# table of frequencies needs to be updated. An alternative could be
# to make this column represent a factor and choose 1.0 to mean
# "this profession is as likely as the average profession", and that
# way new professions can be added / removed without having to modify
# the whole frequencies table. The disadvantage is that it'sn harder to think in
# terms of an abstract "average" profession vs thinking in terms of population
# totals.
...
def generate_profession(gender):
    ...
    # We need this to handle floating point rounding errors.
